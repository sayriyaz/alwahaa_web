...
<head>
  ...
  <link rel="stylesheet" href="./assets/css/main.css?v=20260611e" />
...
<body class="no-js">
  ...
  <header class="site-header" id="header">
    <nav class="nav" aria-label="Primary">
      <a class="brand" href="./index.html" aria-label="Alwahaa Documents Clearing home">
      ...
      <div class="nav__links">
        <a href="./about.html" data-cursor>About Us</a>
        <a href="./index.html#services" data-cursor>Services</a>
        <a href="./index.html#process" data-cursor>Process</a>
        <a href="./index.html#faq" data-cursor>FAQ</a>
        <a href="./blog.html" data-cursor>Newsroom</a>
        <a href="./contact.php" data-cursor aria-current="page">Contact</a>
      </div>
  ...
  <div class="mobile-nav" id="mobileNav">
    <a href="./about.html"><span>01</span>About Us</a>
    <a href="./index.html#services"><span>02</span>Services</a>
    <a href="./index.html#process"><span>03</span>Process</a>
    <a href="./index.html#faq"><span>04</span>FAQ</a>
    <a href="./blog.html"><span>05</span>Newsroom</a>
    <a href="./contact.php" aria-current="page"><span>06</span>Contact</a>
  </div>
          ...
          <div class="cform-wrap" id="form" data-reveal="left">
            <?php if($message_sent): ?>
              <div class="form-success">
                ...
                <a class="btn btn--ghost" href="./index.html" data-magnetic data-cursor>Back to home</a>
              </div>
            <?php else: ?>
              <?php if($send_error): ?>
    ...
    <div class="container">
      <div class="footer__top">
        <div class="footer__brand">
          <a class="brand" href="./index.html"><img src="./assets/img/logo.webp" alt="Alwahaa" width="30" height="35" /><span class="brand__txt"><span class="wahaa">Alwahaa</span><small>Document Clearing</small></span></a>
          <p>Dubai business setup, visa, attestation and PRO services — handled end to end with calm precision since 1983.</p>
        </div>
        <div class="footer__col">
          <h4>Services</h4>
          <a href="./index.html#services">Business Setup</a>
          <a href="./index.html#services">Visa &amp; Immigration</a>
          <a href="./index.html#services">PRO &amp; Government</a>
          <a href="./index.html#catalog">Attestation</a>
          <a href="./index.html#catalog">VAT &amp; Corporate Tax</a>
        </div>
        <div class="footer__col">
          <h4>Company</h4>
